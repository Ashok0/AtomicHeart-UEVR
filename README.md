...
2) Download the Atomic Heart UEVR plugin from [**HERE**](https://github.com/Ashok0/AtomicHeart-UEVR/releases/download/v1.0/AtomicHeart-Win64-Shipping.zip). Click "Import Config" in the UEVR UI and navigate to "AtomicHeart-Win64-Shipping.zip" (make sure the filename does not have any numbers in it) and click on it.
